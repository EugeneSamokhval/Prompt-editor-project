...
\multicolumn{5}{|p{145pt}|} {ГУИР.121703.001 ПЛ} & \multicolumn{4}{|p{200pt}|} {Диаграмма вариантов использования платформы} & \multicolumn{2}{|p{80pt}|} {Формат А1} \\\hline

\multicolumn{5}{|p{145pt}|} {ГУИР.121703.002 ПЛ} & \multicolumn{4}{|p{200pt}|} {Алгоритм оценки качества запроса} & \multicolumn{2}{|p{80pt}|} {Формат А1} \\\hline
...
% 
\centering\textit{\scriptsizeИзм.}&\centering\textit{\scriptsizeЛ.} &\centering\textit{\scriptsize№ докум.} &\centering\textit{\scriptsizeПодп.} &\centering\textit{\scriptsizeДата} & \multirow{6}{150pt}{\centering\textit{Платформа для интерактивного формирования
